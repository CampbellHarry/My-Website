                    ...
                    <div className="w-full flex flex-col px-5 py-5">
                        ...
                        <div className="flex flex-col items-start boxbg w-full rounded-lg p-3">
                                <div className="flex flex-row justify-between w-full items-start">
                                    <div className="flex flex-row gap-3  items-center">
                                        <h1 className="text-zinc-100 font-semibold text-xl">
                                            <a target="_blank" href="https://github.com/Hdev-Group/HSpace">HSpace</a>
                                        </h1>
                                        <div className="bg-teal-300 w-auto px-2 text-black rounded-xl text-sm">Active</div>
                                    </div>
                                ...
                                <div className="mt-1 w-[90%]">
                                    <p className="text-md ">HSpace is a space for people in tech to post, apply to jobs, connect and share their projects.</p>
                                </div>
                                ...
                                <div className="flex flex-row items-end justify-end w-full gap-3">
                                    <a target="_blank" href="https://github.com/Hdev-Group/HSpace" className="flex flex-row items-center gap-1 justify-center hover:text-zinc-50 cursor-pointer transition-all">
                                ...
                                <div className="hidden text-sm w-full flex-col gap-2 mt-4" id="photoexpanderr">
                                    <div className="flex bg-zinc-900/30 text-neutral-200 py-1 gap-3 flex-col px-2 rounded-md">
                                        <p className="font-semibold text-lg">Index</p>
                                        <img src="/hspace/Screenshot 2024-09-17 155237.png"></img>
                                    </div>
                                    <div className="flex bg-zinc-900/30 text-neutral-200 py-1 gap-3 flex-col px-2 rounded-md">
                                        <p className="font-semibold text-lg">Feed</p>
                                        <img src="/hspace/Screenshot 2024-09-17 155210.png"></img>
                                    </div>
                                    <div className="flex bg-zinc-900/30 text-neutral-200 py-1 gap-3 flex-col px-2 rounded-md">
                                        <p className="font-semibold text-lg">Profile Page</p>
                                        <img src="/hspace/Screenshot 2024-09-17 155157.png"></img>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col items-start boxbg w-full rounded-lg p-3">
